...
public class StudentPanel extends JPanel {
    ...
    private void buttonsP() {
        ...
        cancel.setBounds(680,295,60,20);
    ...
    private void table() {
        String []column={"Name","ID","das","19.5"};
